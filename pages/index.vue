  ...
  <div id="layoutDefault">
    <div id="layoutDefault_content">
      <main>
            ...
            <div class="container">
              <div class="row justify-content-center">
                <div class="col-xl-8 col-lg-10 text-center">
                  ...
                  <button class="btn btn-primary btn-marketing rounded-pill">Contactar</button>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="container">
            <div class="row justify-content-center">
              <div class="col-xl-6 col-lg-8 col-md-10 text-center my-5 py-5">
                ...
                <a class="btn btn-primary btn-marketing rounded-pill" href="#!">Contactar</a>
                <a class="btn btn-light btn-marketing rounded-pill" href="https://trello.com/b/LNIwQQ6t/tech-spirit-mallorca" target="_blank">Ver Trello 	&#x2197;</a>
              </div>
            </div>
          </div>
        </section>
          ...
          <div class="container">
            <div class="row text-center">
              ...
              <div class="col-lg-4 mb-5 mb-lg-0">
                ...
                <p
                  class="mb-0"
                >Our award winning development team creates personalized digital experiences</p>
              </div>
              <div class="col-lg-4">
                <div
                  class="icon-stack icon-stack-xl bg-gradient-primary-to-secondary text-white mb-4"
        ...
        <section class="bg-light py-10">
          <div class="container">
            <div class="row brands text-gray-500 align-items-center mb-5">
              ...
              <div class="col-lg-8" data-aos="fade-up">
                <div class="card lift mb-n15">
                  <div class="card-body p-2">
                    <div
                      class="video overlay bg-img-cover rounded"
                      style="background-image: url("https://source.unsplash.com/wD1LRb9OeEo/1500x900")"
                    >
                      <a class="video-link" href="assets/video/video.mp4" data-lity>
            ...
            <div class="card mb-5" data-aos="fade-right">
              <div class="row no-gutters">
                <div class="col-md-6">
                  <img
                    class="img-fluid"
                    src="https://source.unsplash.com/Jbo_StjLDSc/800x550"
                    alt="..."
                  />
                </div>
                <div class="col-md-6">
                  ...
                  >
                    <h3 class="card-title font-weight-bold text-uppercase mb-2">Larq</h3>
                    <p class="card-text font-weight-light mb-4">Performance Bottles</p>
                    <a
                      class="btn btn-outline-dark btn-marketing rounded-pill"
                      href="#!"
                    >View Case Study</a>
                  </div>
                </div>
              ...
              <div class="row no-gutters">
                <div class="col-md-6 order-1 order-md-0">
                  <div
                    class="card-body d-flex align-items-center justify-content-center h-100 flex-column"
                  >
                    <h3 class="card-title font-weight-bold text-uppercase mb-2">Balitello</h3>
                    <p class="card-text font-weight-light mb-4">Designer Socks</p>
                    <a
                      class="btn btn-outline-dark btn-marketing rounded-pill"
                      href="#!"
                    >View Case Study</a>
              ...
              <div class="row no-gutters">
                ...
                <div class="col-md-6">
                  <div
                    class="card-body d-flex align-items-center justify-content-center h-100 flex-column"
                  >
                    <h3 class="card-title font-weight-bold text-uppercase mb-2">Headphones</h3>
                    <p class="card-text font-weight-light mb-4">Premium Audio</p>
                    <a
                      class="btn btn-outline-dark btn-marketing rounded-pill"
                      href="#!"
                    >View Case Study</a>
          ...
          <div class="container">
            <div class="row justify-content-center">
              <div class="col-xl-6 col-lg-8 col-md-10 text-center my-10 py-10">
                ...
                <p
                  class="lead text-gray-500 mb-5"
                >We'd love to hear from you about your branding and digital needs. We are currently accepting new clients.</p>
    ...
    <div id="layoutDefault_footer">
      <footer class="footer pt-5 pb-5 mt-auto bg-black footer-dark">
        <div class="container">
          <!--<div class="row">
            <div class="col-lg-3">
              <div class="footer-brand">Tech Spirit Mallorca</div>
            ...
            <div class="col-lg-9">
              <div class="row">
                <div class="col-lg-3 col-md-6 mb-5 mb-lg-0">
                  <div class="text-uppercase-expanded text-xs mb-4">Comunidades</div>
                  <ul class="list-unstyled mb-0">
                    <li class="mb-2">
                      <a href="https://www.meetup.com/es-ES/MallorcaJS/">Mallorca JS</a>
                    </li>
                    <li class="mb-2">
                      <a
                        href="https://www.meetup.com/es-ES/Women-Techmakers-Mallorca/"
                      >Women Tech Makers / GDG Mallorca</a>
                    </li>
                    <li class="mb-2">
                      <a href="https://www.meetup.com/es-ES/PyData-Mallorca/">PyData Mallorca</a>
                    </li>
                    <li class="mb-2">
                      <a
                        href="https://www.meetup.com/es-ES/Agile-Illes-Balears-Meetup/"
                      >Agile & Learn Illes Balears</a>
                    </li>
                    <li class="mb-2">
                      <a
                        href="https://www.meetup.com/es-ES/Mallorca-Software-Crafters/"
                      >Mallorca Software Crafters</a>
                    </li>
                    <li class="mb-2">
                      <a href="https://www.meetup.com/es-ES/awsusergrouppalma/">AWS User Group Palma</a>
                    </li>
                    <li class="mb-2">
                      <a
                        href="https://www.meetup.com/es-ES/bigdata-machine-learning-mallorca/"
                      >Big Data & Machine Learning</a>
                    </li>
                    <li class="mb-2">
                      <a
                        href="https://www.meetup.com/es-ES/Mallorca-Python-Meetup/"
                      >Mallorca Python Meetup</a>
                    </li>
                  </ul>
                </div>
              </div>
